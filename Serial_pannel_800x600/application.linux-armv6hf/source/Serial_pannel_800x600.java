...
public class Serial_pannel_800x600 extends PApplet {
...
// Mouse Action
 if(mousePressed){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "Serial_pannel_800x600" };
    if (passedArgs != null) {
